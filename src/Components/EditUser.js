...
import { updateUser, getSingleUser } from "../Redux-Thunk/Action";
    ...
    return (
        <>
            <div className="newUserComponent">
                ...
                <h3 className="text-success d-block text-center m-3 mb-2" ><u> Please Enter Details to Update</u> </h3>
                ...
                <form className=" addUser mt-2  " onSubmit={handleSubmit}>
                    ...
                    <div>
                        <button className="btn border-0 rounded  btn-success mx-5 mt-3 mb-3" type="submit"> Update </button>
                    </div>
                </form>
